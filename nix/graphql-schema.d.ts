...
export type EpochDetailsFragment = ({ __typename?: 'Epoch' } & { blocks: Array<({ __typename?: 'Block' } & BlockOverviewFragment)> } & EpochOverviewFragment);
...
export type SearchByIdQuery = ({ __typename?: 'Query' } & { blocks: Array<Maybe<({ __typename?: 'Block' } & BlockDetailsFragment)>>, transactions: Array<Maybe<({ __typename?: 'Transaction' } & TransactionDetailsFragment)>> });

export type SearchForAddressQueryVariables = {
  address: Scalars['String']
};
